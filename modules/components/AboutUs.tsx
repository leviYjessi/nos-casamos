...
const AboutUs = () => {
  return (
    <div className="w-full bg-white flex flex-col items-center pt-10">
      <h3 id="about-us" className="tracking-widest text-xl font-bold">
      ...
      <div className="m-auto bg-white">
        <div className="flex flex-col gap-16 w-[330px] m-auto lg:w-[400px]">
          <HistoryLineSegment
            imageSrc={`${process.env.NEXT_PUBLIC_IMAGES_ROUTE}images/meet.png`}
            imageAlt={""}
            text={"NOS CONOCEMOS"}
            date={"JULIO 2018"}
            textPosition={"left"}
          />
          <HistoryLineSegment
            imageSrc={`${process.env.NEXT_PUBLIC_IMAGES_ROUTE}images/dating.png`}
            imageAlt={""}
          ...
          />
          <HistoryLineSegment
            imageSrc={`${process.env.NEXT_PUBLIC_IMAGES_ROUTE}images/living-together.png`}
            imageAlt={"a"}
            text={"VIVIMOS JUNTOS"}
            date={"MAYO 2019"}
            textPosition={"left"}
      ...
      <p className="text-center bg-white tracking-widest px-6 py-16  max-w-5xl m-auto">
        ¡Acompáñanos en el siguiente gran evento de nuestras vidas!
      </p>
    </div>
  );
};
