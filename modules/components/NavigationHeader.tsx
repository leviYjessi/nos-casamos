      ...
      <div className="flex w-full flex-row justify-between max-w-5xl">
        ...
        {isMobile ? (
          ...
          >
            ...
            >
              <div
                className={`flex flex-col tracking-widest  leading-6 px-4 pt-10 ${
              ...
              <div
                className={`flex flex-col tracking-widest  leading-6 px-4 pt-6 ${
                  router.pathname === "/about-us" && "font-bold underline"
                }`}
              >
              ...
              <div
                className={`flex flex-col tracking-widest  leading-6 px-4 pt-6 ${
                  router.pathname === "/confirmation" && "font-bold underline"
                }`}
              >
              ...
              <div
                className={`flex flex-col tracking-widest  leading-6 px-4 pt-6 ${
                  router.pathname === "/songs" && "font-bold underline"
                }`}
              >
