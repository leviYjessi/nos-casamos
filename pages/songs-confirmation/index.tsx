    ...
    <div>
      ...
      <div className="min-h-[calc(100vh-112px)] max-w-5xl m-auto bg-grey-bg lg:text-base px-6">
        ...
        <p className="text-center tracking-widest pt-6 ">
          Pasaremos una lista de canciones preferidas de los invitados al DJ
          para que todos disfrutemos de la fiesta.
        </p>
        <p className="text-center tracking-widest pt-6">
          ¡Esperamos que lo des todo en la pista de baile!
        </p>
        <div className="flex flex-col items-center w-full bg-grey-bg pt-16 pb-6 max-w-5xl m-auto">
          <Image
