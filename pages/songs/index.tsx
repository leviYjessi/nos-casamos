...
const Index = () => {
  ...
  return (
    <div>
      <NavigationHeader />
      <div className="min-h-[calc(100vh-112px)] max-w-5xl m-auto bg-grey-bg lg:text-base ">
        ...
        <div className="px-6 lg:px-44 relative">
          ...
          <form onSubmit={handleSubmit} className="flex flex-col">
            <label className=" text-black pt-4 z-10" htmlFor="songs">
              Escribe aquí tus peticiones para el DJ
            </label>
            <textarea
              className="z-10 bg-light-grey border border-primary-grey italic p-3 mt-2"
              id="songs"
              name="songs"
              rows={4}
              cols={50}
            ...
            <div className="flex justify-end">
              <button
                className="py-3 px-10 mt-8 font-bold tracking-widest leading-6 bg-black text-white"
                type="submit"
                disabled={hasSubmit}
              >
                ENVIAR
